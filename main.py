...
def main():
    ...
    application.add_handler(CallbackQueryHandler(comeback_handler, pattern=r"^cb_\d+_\d+$"))
    application.add_handler(CallbackQueryHandler(train_handler, pattern=r"^tr_\d+_\d+$"))
    application.add_handler(CallbackQueryHandler(greet_handler, pattern=r"^gr_\d+_\d+$"))
    application.add_handler(CallbackQueryHandler(rest_handler, pattern=r"^rs_\d+_\d+$"))
    application.add_handler(CallbackQueryHandler(tour_handler, pattern=r"^tour_\d+_\d+$"))
    application.add_handler(CallbackQueryHandler(sell_handler, pattern=r"^sell_\d+_\d+$"))
